...
<div class="container py-4">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <form id="feeStructureForm" action="{{ route('fee-structures.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-success px-4">Save Fee Structure</button>
