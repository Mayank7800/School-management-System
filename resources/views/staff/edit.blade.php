...
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-warning text-white">
            <h4 class="mb-0">Edit Staff: {{ $staff->first_name }} {{ $staff->last_name }}</h4>
        </div>
        ...
        <form id="staffForm" action="{{ route('staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-step active card p-4 mb-4 shadow-sm">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="first_name" class="form-control capitalize @error('first_name') is-invalid @enderror" 
                               value="{{ old('first_name', $staff->first_name) }}" required maxlength="50">
                        @error('first_name')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="middle_name" class="form-control capitalize @error('middle_name') is-invalid @enderror" 
                               value="{{ old('middle_name', $staff->middle_name) }}" maxlength="50">
                        @error('middle_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="last_name" class="form-control capitalize @error('last_name') is-invalid @enderror" 
                               value="{{ old('last_name', $staff->last_name) }}" required maxlength="50">
                        @error('last_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="dob" class="form-control @error('dob') is-invalid @enderror" 
                               value="{{ old('dob', $staff->dob) }}" max="{{ date('Y-m-d') }}">
                        @error('dob')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="blood_group" class="form-control @error('blood_group') is-invalid @enderror" 
                               value="{{ old('blood_group', $staff->blood_group) }}">
                        @error('blood_group')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nationality" class="form-control capitalize @error('nationality') is-invalid @enderror" 
                               value="{{ old('nationality', $staff->nationality ?? 'Indian') }}">
                        @error('nationality')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="aadhaar_number" class="form-control @error('aadhaar_number') is-invalid @enderror" 
                               value="{{ old('aadhaar_number', $staff->aadhaar_number) }}" maxlength="12" pattern="^[0-9]{12}$">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="pan_number" class="form-control @error('pan_number') is-invalid @enderror" 
                               value="{{ old('pan_number', $staff->pan_number) }}" maxlength="10" pattern="^[A-Z]{5}[0-9]{4}[A-Z]{1}$">
                        @error('pan_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" 
                               value="{{ old('mobile', $staff->mobile) }}" maxlength="10" pattern="^[0-9]{10}$" required>
                        @error('mobile')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="alternate_mobile" class="form-control @error('alternate_mobile') is-invalid @enderror" 
                               value="{{ old('alternate_mobile', $staff->alternate_mobile) }}" maxlength="10" pattern="^[0-9]{10}$">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="address_line1" class="form-control @error('address_line1') is-invalid @enderror" 
                               value="{{ old('address_line1', $staff->address_line1) }}">
                        @error('address_line1')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="address_line2" class="form-control @error('address_line2') is-invalid @enderror" 
                               value="{{ old('address_line2', $staff->address_line2) }}">
                        @error('address_line2')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="city" class="form-control capitalize @error('city') is-invalid @enderror" 
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="state" class="form-control capitalize @error('state') is-invalid @enderror" 
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pincode" class="form-control @error('pincode') is-invalid @enderror" 
                               value="{{ old('pincode', $staff->pincode) }}" maxlength="6" pattern="^[0-9]{6}$">
                        @error('pincode')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="country" class="form-control capitalize @error('country') is-invalid @enderror" 
                               value="{{ old('country', $staff->country ?? 'India') }}">
                        @error('country')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="joining_date" class="form-control @error('joining_date') is-invalid @enderror" 
                               value="{{ old('joining_date', $staff->joining_date) }}" max="{{ date('Y-m-d') }}">
                        @error('joining_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="department" class="form-control capitalize @error('department') is-invalid @enderror" 
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="designation" class="form-control capitalize @error('designation') is-invalid @enderror" 
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="qualification" class="form-control capitalize @error('qualification') is-invalid @enderror" 
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="experience" class="form-control @error('experience') is-invalid @enderror" 
                               value="{{ old('experience', $staff->experience) }}" min="0">
                        @error('experience')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="specialization" class="form-control capitalize @error('specialization') is-invalid @enderror" 
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="shift_timing" class="form-control @error('shift_timing') is-invalid @enderror" 
                               value="{{ old('shift_timing', $staff->shift_timing) }}">
                        @error('shift_timing')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="reporting_to" class="form-control capitalize @error('reporting_to') is-invalid @enderror" 
                               value="{{ old('reporting_to', $staff->reporting_to) }}">
                        @error('reporting_to')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="basic_salary" class="form-control @error('basic_salary') is-invalid @enderror" 
                               value="{{ old('basic_salary', $staff->basic_salary) }}" min="0" step="0.01">
                        @error('basic_salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="allowances" class="form-control @error('allowances') is-invalid @enderror" 
                               value="{{ old('allowances', $staff->allowances) }}" min="0" step="0.01">
                        @error('allowances')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="deductions" class="form-control @error('deductions') is-invalid @enderror" 
                               value="{{ old('deductions', $staff->deductions) }}" min="0" step="0.01">
                        @error('deductions')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="net_salary" class="form-control @error('net_salary') is-invalid @enderror" 
                               value="{{ old('net_salary', $staff->net_salary) }}" min="0" step="0.01">
                        @error('net_salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="payment_mode" class="form-select @error('payment_mode') is-invalid @enderror">
                            <option value="">Select</option>
                            <option value="Cash" {{ old('payment_mode', $staff->payment_mode) == 'Cash' ? 'selected' : '' }}>Cash</option>
                            <option value="Bank" {{ old('payment_mode', $staff->payment_mode) == 'Bank' ? 'selected' : '' }}>Bank</option>
                            <option value="UPI" {{ old('payment_mode', $staff->payment_mode) == 'UPI' ? 'selected' : '' }}>UPI</option>
                        </select>
                        @error('payment_mode')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="bank_name" class="form-control capitalize @error('bank_name') is-invalid @enderror" 
            ...
            @if($staff->photo)
                <div class="mt-1">
                    <small class="text-success">
                        ...
                        Current file: 
                       <a href="{{ asset('storage/app/public/' . $staff->photo) }}" target="_blank" class="text-decoration-none">
                            View Current Photo
                        </a>
                    </small>
                </div>
            ...
            @if($staff->aadhaar_file)
                <div class="mt-1">
                    <small class="text-success">
                        <i class="bi bi-file-earmark-check"></i> 
                        Current file: 
                       <a href="{{ asset('storage/app/public/' . $staff->aadhaar_file) }}" target="_blank" class="text-decoration-none">
        ...
        <div class="col-md-4">
            ...
            @if($staff->pan_file)
                <div class="mt-1">
                    <small class="text-success">
                        <i class="bi bi-file-earmark-check"></i> 
                        Current file: 
                       <a href="{{ asset('storage/app/public/' . $staff->pan_file) }}" target="_blank" class="text-decoration-none">
                            View Current PAN
                        </a>
                    </small>
                </div>
            @endif
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror" rows="3">{{ old('remarks', $staff->remarks) }}</textarea>
                        @error('remarks')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-between mt-3">
                    <button type="button" class="btn btn-secondary prev-step"><i class="bi bi-arrow-left"></i> Previous</button>
                    <button type="submit" class="btn btn-success">Update Staff <i class="bi bi-check-circle"></i></button>
                </div>
            </div>
        </form>
    </div>
